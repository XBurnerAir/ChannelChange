...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
                ...
                final MyViewHolder myHolder = new MyViewHolder(view);
                    ...
                    myHolder.imgEdit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Log.e("TAG","myHolder.getAdapterPosition()--->"+position);
                            if(isEditMode){
                    ...
                    myHolder.textView.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(final View v) {
                            ...
                            if(!(position-COUNT_PRE_MY_HEADER==0)){
                                Log.e("TAG","kanyoumeiyoujinlai");
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Log.e("TAG","mMyChannelItems.toString()--->"+mMyChannelItems.toString());
        Log.e("TAG","mMyChannelItems.toString()--->"+position);
        if (holder instanceof MyViewHolder) {
            ...
            Log.e("TAG","mMyChannelItems.toString()--->"+mMyChannelItems.get(position-COUNT_PRE_MY_HEADER).toString());

            ChannelEntity channelEntity=mMyChannelItems.get(position-COUNT_PRE_MY_HEADER);

            myHolder.textView.setSelected(channelEntity.isSeclect());
            ...
            Log.e("TAG","MyChannelHeaderViewHolder");
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        int position = myHolder.getAdapterPosition();
        Log.e("TAG","moveMyToOther---position---"+position);
        ...
        if (item.isSeclect()) {
            ...
            if (startPosition == mMyChannelItems.size()) {
                Log.e("TAG", "startPosition-1---" + startPosition);
                mMyChannelItems.get(startPosition - 1).setSeclect(true);
                notifyItemChanged(startPosition);
            } else {
                Log.e("TAG", "startPosition---" + startPosition);
                mMyChannelItems.get(startPosition).setSeclect(true);
    ...
    private void startEditMode(RecyclerView parent) {
        ...
        for (int i = 0; i < visibleChildCount; i++) {
            ...
            if(textView!=null){
                ...
                if(i<=mMyChannelItems.size()&&i!=0){

                    ChannelEntity channelEntity=mMyChannelItems.get(i-1);

                    textView.setSelected(channelEntity.isSeclect());

                    Log.e("TAG","isSeclect-->"+channelEntity.isSeclect());
                ...
                if(i==1){
                    ...
                    if(!channelEntity.isSeclect()){
                        textView.setBackgroundResource(R.drawable.bg_channel_nocheck);
                    }else {
                        textView.setSelected(channelEntity.isSeclect());
                    }
